...
class ExpConfig():
    def __init__(self):
        # ID and Name
        self.experiment_name = "atlas_unet_3D_resolution_01"
        self.id = 6
        ...
        self.net = unet_3D(self.channels, n_classes=12, is_batchnorm=False, in_channels=1, interpolation = (512, 512, 198))#1, self.channels, 12, interpolation = (512,512,198))
