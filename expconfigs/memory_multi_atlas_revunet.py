...
class ExpConfig():
    def __init__(self):
        ...
        self.net = memory_unet_3D(self.channels, is_batchnorm=False, n_classes=12, in_channels=1, interpolation = (512, 512, 198))#1, self.channels, 12, interpolation = (512,512,198))
