...
class ExpConfig():
    def __init__(self):
        # ID and Name
        self.experiment_name = "atlas_revunet_3D_1_v1"
        self.id = 9
        ...
        self.datapath = "/local/SSD_DEEPLEARNING/MULTI_ATLAS/multi_atlas/data_3D_size_512_512_198_res_1.0_1.0_1.0.hdf5"
        ...
        self.net = RevUnet3D(1, self.channels, 14, interpolation = (512,512,198))
