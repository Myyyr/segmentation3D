...
class ExpConfig():
    def __init__(self):
        # ID and Name
        self.id = 132
        self.experiment_name = "multi_atlas_revunet_03_d3_e2000_CE_adam_wd0_bs1_da_lr6_id{}".format(self.id)
        self.debug = False
...
#        self.labelpath = "/local/SSD_DEEPLEARNING/MULTI_ATLAS/multi_atlas/data_3D_size_512_512_198_res_1.0_1.0_1.0.hdf5"
        ...
        self.labelpath = "/local/SSD_DEEPLEARNING/MULTI_ATLAS/multi_atlas/data_3D_size_160_160_64_res_0.3.hdf5"
