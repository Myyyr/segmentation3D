...
class ExpConfig():
    def __init__(self):
        ...
        self.checkpointsBasePathMod = self.checkpointsBasePath + './checkpoints/models/'
        ...
        self.net = memory_unet_3D(self.channels, n_classes=14, is_batchnorm=False, in_channels=1, interpolation = None)#1, self.channels, 12, interpolation = (512,512,198))
