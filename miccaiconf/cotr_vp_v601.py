...
class ExpConfig():
    def __init__(self):
        ...
        self.labelpath = '/local/DEEPLEARNING/VP_multiorgan_v2/3d_images/'
    ...
    def set_data(self, split = 0):
        # Data
        self.trainDataset = PatchedVPDataset(self, mode="train", n_iter=250, patch_size=self.patch_size, return_full_image=False, ds_scales=self.ds_scales, do_tr=True, return_pos=False, split=0)
        self.testDataset  = PatchedVPDataset(self, mode="test", n_iter=1, patch_size=self.patch_size, return_full_image=False, ds_scales=None, do_tr=False, return_pos=False, split=0)
