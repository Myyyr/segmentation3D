...
class ExpConfig():
    def __init__(self):
        ...
        self.net = UNetTransformer(filters = self.channels, n_classes=2, in_channels=1,n_heads=1, dim='2d', bn=False, up_mode='deconv')
        self.n_parameters = count_parameters(self.net)
        print("N PARAMS : {}".format(self.n_parameters))

        self.model_path = './checkpoints/models/pancreas2D_utrans_kaiming_nobn_deconv.pth'
        self.load_model()
        ...
        self.lr_scheduler = get_scheduler(self.optimizer, "po", {'lr':self.lr_rate, 'decay':self.decay})
        # Other
    ...
    def set_data(self, split = 0):
        ...
        testDataset = SplitTCIA2DDataset(self.datapath, self.split, self.generate_splits('test'), mode = 'test')
