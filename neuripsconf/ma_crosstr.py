...
class ExpConfig():
    def __init__(self):
        ...
        # Model
        self.n_classes = 14
        self.net = CrossPatch3DTr(filters=self.filters,patch_size=[1,1,1],d_model=128,n_classes=self.n_classes,n_cheads=2,n_sheads=2,bn=True,up_mode='deconv',n_strans=1)
