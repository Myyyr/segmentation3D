...
class ExpConfig():
    def __init__(self):
        ...
        self.n_classes = 14
        self.net = CrossPatch3DTr(filters=self.filters,use_trans=[0,0,0,0,1,1],
        ...
        self.ds_scales = ((1, 1, 1), (0.5, 0.5, 0.5), (0.25, 0.25, 0.25), (0.125,0.125,0.125),(0.0625,0.0625,0.125))
