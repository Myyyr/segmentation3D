...
class ExpConfig():
    ...
    def set_data(self, split = 0):
        ...
        self.trainDataLoader = DataLoader(dataset=self.trainDataset, num_workers=16, batch_size=self.batchsize, shuffle=True)
        self.testDataLoader = DataLoader(dataset=self.testDataset, num_workers=16, batch_size=1, shuffle=False)
