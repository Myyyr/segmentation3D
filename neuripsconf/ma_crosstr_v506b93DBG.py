...
from PatchedMultiatlasDataset_debug import *
from torch.utils.data import DataLoader
import torch
import torchio as tio

from models.mymod.cross_patch_debugdeep import CrossPatch3DTr
...
class ExpConfig():
    def __init__(self):
        ...
        self.datapath = '/local/DEEPLEARNING/MULTI_ATLAS/MULTI_ATLAS/FEATURES_AND_SKIPS/'
    ...
    def set_data(self, split = 0):
        ...
        self.trainDataLoader = DataLoader(dataset=self.trainDataset, num_workers=4, batch_size=self.batchsize, shuffle=True)
        self.testDataLoader = DataLoader(dataset=self.testDataset, num_workers=4, batch_size=1, shuffle=False)
